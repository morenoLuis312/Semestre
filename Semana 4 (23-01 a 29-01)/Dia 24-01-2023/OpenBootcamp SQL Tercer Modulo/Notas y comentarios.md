...
Notas:
* Para restriccion de datos no nulos es NOT NULL
* Para restrición se usa la palabra CHECK seguido de la restricción (presio >= 0)
* Se pueden crear dos llaves primarias para relaciones mucho a muchos para este caso
```
|  1  |  1  | Se evita la duplicidad de 1 y 1 dos veces
|  1  |  1  | X 
|  1  |  2  | ✓
```


1:18:00  NO COMPLETADO

### Consesionario Database
